...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Meshify}{Austin, TX}
      \resumeItemListStart
        \resumeItem{Streamlined user administration across multiple platforms, ensuring adherence to Role-Based Access Control (RBAC) standards. This initiative resulted in a notable reduction of $4,000 in monthly operational costs.}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Provide troubleshooting support to address 20+ network issues reported by customers, ensuring timely resolution and maintaining high levels of customer satisfaction.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Administerd Active Directory (AD) by creating a combined 50+ users, groups and organizational units following least privilege, ensuring compliance with security standards and reducing risk of unauthorized access.}
